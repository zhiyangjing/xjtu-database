...
suspend fun loadNullGradeEnrollments(limit: Int): List<EnrollmentKey> = withContext(Dispatchers.IO) {
    val sql = """
...
suspend fun deleteEnrollmentsParallel(
    keys: List<db.rm_null.EnrollmentKey>,
    threadCount: Int = 4
) = coroutineScope {
...
fun main() = runBlocking {
    println("加载成绩为 NULL 的选课记录...")
    val toDelete = loadNullGradeEnrollments(100)
